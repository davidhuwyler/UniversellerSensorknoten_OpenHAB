/* ###################################################################
**     Filename    : Events.c
**     Project     : UniversalSensornode
**     Processor   : MK20DX256VLH7
**     Component   : Events
**     Version     : Driver 01.00
**     Compiler    : GNU C Compiler
**     Date/Time   : 2015-03-17, 13:33, # CodeGen: 0
**     Abstract    :
...
/*
** ===================================================================
**     Event       :  PIR1_OnInterrupt (module Events)
**
**     Component   :  PIR1 [ExtInt]
**     Description :
...
** ===================================================================
*/
void PIR1_OnInterrupt(void)
{
	if(PIR1_Get()){
		PIR_OnInterrupt(KEY_PIR1);
	}
}

/*
** ===================================================================
**     Event       :  PIR2_OnInterrupt (module Events)
**
**     Component   :  PIR2 [ExtInt]
**     Description :
**         This event is called when an active signal edge/level has
**         occurred.
**     Parameters  : None
...
** ===================================================================
*/
void PIR2_OnInterrupt(void)
{
	if(PIR2_Get()){
		PIR_OnInterrupt(KEY_PIR2);
	}
}
...
void AS1_OnRxChar(void)
{
	static int counter;
	counter++;
	if(AS1_GetCharsInRxBuf() >= NOF_BYTES_IN_TICKET){
		counter = 0;
		SEM_give_RSsemFromISR();
	}
...
/*
** ===================================================================
**     Event       :  RNG1_OnItemGet (module Events)
**
**     Component   :  RNG1 [RingBuffer]
**     Description :
